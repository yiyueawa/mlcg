...
"#;
    ...
    let empty_rust_name_manifest = r#"
version = "fixture"
...
outputs = []
"#;
    let empty_rust_name_manifest_path =
        PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("tests/empty_rust_name_manifest.toml");
    fs::write(&empty_rust_name_manifest_path, empty_rust_name_manifest)
        .expect("write empty rust name manifest");
    let trybuild_empty_rust_name_manifest_path = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join(
        "../../target/tests/trybuild/mlcg_builtin_macros/tests/empty_rust_name_manifest.toml",
    );
    fs::write(
        &trybuild_empty_rust_name_manifest_path,
        empty_rust_name_manifest,
    )
...
"#;
    ...
    let whitespace_emit_token_manifest = r#"
version = "fixture"
...
outputs = []
"#;
    let whitespace_emit_token_manifest_path =
        PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("tests/whitespace_emit_token_manifest.toml");
    fs::write(
        &whitespace_emit_token_manifest_path,
        whitespace_emit_token_manifest,
    )
    .expect("write whitespace emit token manifest");
    let trybuild_whitespace_emit_token_manifest_path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join(
        "../../target/tests/trybuild/mlcg_builtin_macros/tests/whitespace_emit_token_manifest.toml",
    );
    fs::write(
        &trybuild_whitespace_emit_token_manifest_path,
        whitespace_emit_token_manifest,
    )
