...
fn generated_v158_1_api_emits_representative_mlog() {
    ...
    let radar_target = x.uradar("enemy", "any", "any", "distance", true);
    x.uradar_into(radar_target.clone(), "enemy", "any", "any", "health", false);
